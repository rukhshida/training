...
// // replace
// console.log(result.replace("home","everyone"));

// // includes
// console.log(result.includes("homes"));

// // slice
// console.log(result.slice(1,4));

// // concat
// console.log(result.concat("amazing javascript"));
